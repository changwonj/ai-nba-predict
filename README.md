...
The dataset that we used for our project was provided by [JK-Future-Github](https://github.com/JK-Future-GitHub/NBA_Champion/tree/main), who used a web crawler to collect data from Basketball Reference. He also added additional features such as Top_3_Conference, which describes whether the team finished within the top 3 in their respective conference.

In order to make the dataset as clean as possible, We removed all seasons before 1980. In 1980, the NBA introduced the three point line, introducing a whole new group of statistics. As a result, any data from seasons prior to 1980 are extremely sparse, and therefore were removed. The 2023 season was also removed, as at the point in time when the data collected, the 2023 season was yet to be completed.
...
We used the libraries provided by [XGBoost](https://xgboost.readthedocs.io/en/stable/index.html) and [scikit-learn](https://scikit-learn.org/stable/index.html):
...
- [XGBoost (Gradient Boost)](https://xgboost.readthedocs.io/en/stable/index.html)
- [scikit-learn (Random Forest)](https://scikit-learn.org/stable/index.html)
